...
### Seção-3-introdução-à-javascript00-de-06

#### dia-01-javascript-primeiros-passos
#### dia-02-javascript-array-e-loop-for
#### dia-03-javascript-funções
#### dia-04-javascript-objetos
### Seção-05-javascript-es6-let-const-arrow-functions-e-template-literals

#### dia-06-projeto-playground-functions

### Seção-4-javascript-dom-eventos-e-web-storage00-de-06
...
### Seção-5-html-e-css-forms-flexbox-e-responsivo00-de-06
...
### Seção-6-introdução-à-javascript-es6-e-testes-unitários00-de-04
...
### Seção-7-higher-order-functions-do-javascript-es600-de-06
...
### Seção-10-projeto-app-de-receitas00-de-01
...
### Seção-1-Docker-Utilizando-Containers00-de-04
...
### Seção-2-Introdução-à-SQL00-de-05
...
### Seção-3-Funções-SQL-JOINs-e-Normalização00-de-04
...
### Seção-4-Introdução-ao-desenvolvimento-Web-com-Nodejs00-de-06

#### Dia-01-Nodejs-Runtime-Assíncrono
#### Dia-02-Nodejs-API-REST-com-Express
#### Dia-03-Nodejs-Testes-de-Integração
#### Dia-04-Nodejs-Express-e-Middlewares
#### Dia-05-Nodejs-Express-e-MySQL
#### Dia-06-Projeto--Talker-Manager

### 5-Arquitetura-de-Software-Model-Service-e-Controller00-de-04
...
### Seção-6-Nodejs-ORM-e-Autenticação00-de-05

#### Dia-01-ORM--Interface-da-aplicação-com-o-banco-de-dados
#### Dia-02-ORM--Associations-11-e-1N
#### Dia-03-ORM--Associations-NN-e-Transactions
#### Dia-04-JWT--(JSON-Web-Token)
#### Dia-05-Projeto--API-de-Blogs

### Seção-7-Masterclass-Implantação-de-Aplicações-na-Nuvem00-de-01

#### Dia-01-Infraestrutura-Deploy-com-Railway

### Seção-8-Introdução-a-TypeScript00-de-04
...
### Seção-9-Programação-Orientada-a-Objetos-(POO)-e-SOLID00-de-06
...
### Seção-10-Projeto--TFC--Trybe-Futebol-Clube00-de-01

#### Dia-01-Projeto--TFC--Trybe-Futebol-Clube

#### Seção-11-Introdução-ao-MongoDB00-de-06
...
### Seção-12-APIs-OO-e-NoSQL00-de-03
...
### Seção-13-Projeto--App-de-Delivery00-de-01
...
#### dia-04-projeto-relatórios-de-_1-liçãoestoque
...
### Seção5-Estruturas de Dados: Arrays, Listas, Filas e Pilhas
...
### Seção-6-estruturas-de-dados-II-hashmaps-e-sets

#### dia-01-hashmap-e-dict
#### dia-02-set
#### dia-03-pandas
#### dia-04-projeto-restaurant-orders
